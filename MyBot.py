...
class MyBotRandom(Player):          #erster Bot, der zufälligen Spielzug spielt
    ...
    def make_move(self, board):                                             #lässt Bot spielen, benötigt allerdings eigene make_move Methode, da Verfahren anders
...
class MyBotReactive(Player):                                                #zweiter Bot, der reaktiv spielt
    ...
    def make_move(self, board):                                             #erneut eigene Methode, da Verfahren auch hier wieder anders zu vorherigen
